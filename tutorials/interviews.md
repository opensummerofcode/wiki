...
* Look at the [project description](https://docs.google.com/spreadsheets/d/1LEOFnsOYX1sOJuNBzhD277bCgdci9O\_vAOphsx2vnGE/edit?usp=sharing) sheet to see what question you have to answer
  * Fill out your **name**
...
* We show 3 pitches from 3 teams, and then we take a moment to hear the answers from the representatives of those 3 teams.
  * When your team's pitch is about to go up, go to the **Waiting room in discord**. The other 2 (or 3 in the last round) representatives will be waiting there too.\
    _Turn off your notifications._
  * When it's time to answer your question, you'll get introduced to the **Pitch Arena**.\
    I'll say hi, bring you on the screen – excited to hear your answer 😊**.** \
    ****_Make sure you mute the YouTube stream so we don't get feedback!_
